...
if (auth != null) {
    if(!auth.getAdmin())response.sendRedirect("index.jsp");
...
if (product == null) {
    // Se il prodotto non esiste, reindirizza a una pagina di errore o alla lista dei prodotti
...
<div class="container">
    ...
    <!-- Aggiungi il pulsante di eliminazione del prodotto -->
